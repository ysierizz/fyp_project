...
class PatientPolicy
{
    ...
    public function generatePdf(User $user, Patient $patient)
    {
        // Define the roles or permissions that are allowed to generate PDF
        return $user->hasRole('super-admin') || $user->hasRole('doctor');
    }
}
