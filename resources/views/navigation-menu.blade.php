        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        @endcan
                        @can('view-any', App\Models\Assessment::class)
                    ...
                    <x-nav-dropdown title="Access Management" align="right" width="48">
                        ...
                        @can('view-any', Spatie\Permission\Models\sessions_manager::class)
                        <x-dropdown-link href="{{ route('sessions.show') }}">Session</x-dropdown-link>
                        @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\Patient::class)
                <x-jet-responsive-nav-link href="{{ route('patients.index') }}">
                Patients
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Question::class)
